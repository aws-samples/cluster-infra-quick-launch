...
class ProvisioningParameters:
    ...
    @property
    def efs_id(self) -> Optional[str]:
        return self._params.get(ProvisioningParameters.EFS_ID)

    @property
    def bucketname(self) -> Optional[str]:
        return self._params.get(ProvisioningParameters.BUCKET_NAME)
...
def main(args):
    ...
    ExecuteBashScript("./install_efs.sh").run()
    ...
    ExecuteBashScript("./install_efs_remount_service.sh").run()
    bucketname = params.bucketname
    ExecuteBashScript("./mount_s3.sh").run(bucketname)
